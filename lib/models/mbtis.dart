...
class Mbtis {
  static const Map<String, Map> Types = {
    "INTJ": {
      ...
      "details": [
        "전 세계의 2%로 매우 드물며 여성만의 비율로 따진다면 0.8%로 매우 드물다.(대한민국은 1%)",
        "아주 이론적이다.",
        "성격을 알기 힘들기로 악명 높다.",
        ...
        "MBTl 유형 중 IQ는 1위, 대학수학능력시험 성적 평균은 ISTJ에 이은 2위이다.국어, 과학탐구는 근소하게 ISTJ보다 앞서나, 수학, 영어, 사회탐구는 다소 밀려 2위로 분석됐다.",
        ...
        "규범적인 주장에 합리적인 근거가 없으면 수준 낮은 것으로 취급한다.",
        ...
        "기계나 소프트웨어 엔지니어, 변호사, 프리랜서 컨설턴트로서 외로운 늑대같은 직업을 선호한다.",
        ...
        "말과 행동에 있어 정직함을 추구하기 때문에 연애������� 어렵게 만들기도 한다.",
        "앞에 나서는 것을 두려워 한다.",
        ...
        "부모로서 자녀에게 환상, 동심에 의한 잘못된 정보보단 진실을 아는 것이 더 낫다는 전제 하에 의사소통이 이루어진다.",
        ...
        "여기 나열된 특성들을 모두 자랑스러워하고 있을 것이다.",
      ],
    },
    "INTP": {
      "celebrities_ko": ["진", "Jae", "임현식"],
      "celebrities": ["빌 게이츠", "엘런 페이지", "크리스틴 스튜어트", "아이삭 뉴턴", "아인슈타인"],
      "matching": {
        "best": ['ENTJ', 'ESTJ'],
        "good": ['INFP', 'ENFP', 'INFJ', 'ENFJ', 'INTJ', 'INTP', 'ENTP'],
        "normal": ['ISFP', 'ESFP', 'ISTP', 'ESTP'],
        "not_bad": ['ISFJ', 'ESFJ', 'ISTJ'],
      },
      "type": "분석형",
      "character": "Logician",
      "character_ko": "논리적인 사색가",
      "color": 0xFF5F384C,
    ...
    "ENTP": {
      "celebrities_ko": ["육성재", "영케이", "설리"],
      "celebrities": ["마크 트웨인", "톰 행크스", "토마스 애디슨", "셀린 디온"],
      "matching": {
        "best": [
          'INFJ',
          'INTJ',
      ...
      "type": "분석형",
      "character": "Debater",
      "character_ko": "논쟁을 즐기는 변론가",
      "color": 0xFF5F384C,
      "summary": "지적인 도전을 두려워하지 않는 똑똑한 호기심 형",
      "details": [
        "5대양 6대주가 활동 무대.",
    ...
    "INFJ": {
      ...
      "celebrities_ko": ["JB", "하니", "원우", "우지", "디에잇"],
      "matching": {
        "best": ['ENFP', 'ENTP'],
        "good": ['INFP', 'INFJ', 'ENFJ', 'INTJ', 'ENTJ', 'INTP'],
    ...
    "INFP": {
      "celebrities": ["윌리엄 셰익스피어", "조니 뎁", "줄리아 로버츠", "톰 히들스턴", "앨리샤 키스"],
      "celebrities_ko": [
        "슈가",
        "정국",
        "원호",
    ...
    "ISTJ": {
      ...
      "celebrities_ko": ["마크(갓세븐)", "정찬우", "이창섭", "차태현"],
      "matching": {
        "best": [
          'ESFP',
          'ESTP',
      ...
      "character_ko": "청렴결백한 논리주의자",
      "color": 0xFF52A9AB,
      "summary": "사실에 근거하여 사고하며 이들의 행동이나 결정 사항에 한 치의 의심을 사지 않는 현실주의자형.",
      "details": [
        "오래된 조직을 좋아한다.",
        "부하 직원을 부모와 자녀 관계같이 돌보려고 한다.",
        "선입견이 강하다.",
        "친숙하지 않은 장소에 나서기를 주저한다.",
        "지나고 난 다음에 따지는 편이다.",
        "주어진 업무나 책임을 끝까지 완수한다.",
        "우리나라에서는 장남 같다, 장녀 같다 라는 소리를 잘 듣는다.",
        "변화에 적응이 더디다.",
        "MBTl 유형 중 대학수학능력시험 성적 평균은 1위이다. 다만 수리, 사회탐구, 영어는 최우위에 있으나 언어, 과학탐구는 전 영역 평균치 2위인 INTJ에 근소하��� 밀린���.",
        "희한하게도 IQ는 16가지 유형의 평균치를 상회하지 않는다. 유독 ISTJ가 학업 성적과 지능 사이에 괴이한 편차를 보이고 있다.",
        "원리 원칙적이다.",
        ...
        "웃음이 적다.",
        "반대 성향을 지닌 사람과 처음에는 원만히 지내나 결국 멀어짐.",
        "잘못했다는 건 인정하면서도 미안하다, 잘못했다라고 잘 못한다.",
        "정리정돈을 해 놓는 것이 우선이다.",
        "직설적인 표현을 많이 하는 편이다.",
        "한국에서 제일 많은 유형이다.",
      ]
    ...
    "ISFJ": {
      ...
      "celebrities_ko": ["태연", "셔누", "진영(갓세븐)", "영재", "정한"],
      "matching": {
        "best": [
          'ESFP',
          'ESTP',
    ...
    "ESTJ": {
      "celebrities": ["소니아 소토마요르", "존 D. 록펠러", "프랭크 시나트라", "제임스 먼로"],
      "celebrities_ko": ["뱀뱀", "한채영", "데프콘"],
      "matching": {
        "best": [
          'INTP',
          'ISFP',
    ...
    "ESFJ": {
      ...
      "details": [
        ...
        "아무 생각없이 멍 때리기를 잘한다.",
        "100분 동안 싸우곤 뭐가 문제였는가 곰곰이 돌이켜보는 것은 10분 만에 끝난다.",
    ...
    "ISFP": {
      ...
      "celebrities_ko": ["진환", "도운", "아이엠", "서은광", "이민혁", "수빈(TXT)"],
      "matching": {
        "best": [
          'ENFJ',
          'ESFJ',
      ...
      "details": [
        ...
        "자연적인 것, 목가적인 것, 전원적인 것을 갈구한다.",
        "생각은 많은데 행동은 부족하다.",
        "싸울 때 감정이 앞선다.",
        "계획성이 없다.",
        "공감 능력이 뛰어나다.",
        "남에게 싫은 소리는 안 한다.",
        "타인을 이해해 주고 자기 의견과는 상관없이 따라가 준다.",
        "즐기는 것에 대한 호기심이 ��다.",
  ...
  static const Map<String, Color> EmojiColor = {
    "best": Colors.blue,
    "good": Colors.green,
    "normal": Color(0xFFf4d30e),
    "not_bad": Colors.orange,
    "bad": Colors.red,
  };
  ...
  static const Map<String, String> ExploreCategories = {
    "intro": "소개",
    "strength_and_weakness": "장점과 약점",
    "love": "사랑",
    "friendship": "우정",
    "family": "가정",
    "career": "커리어",
  ...
  static const Map<String, List> ExploreTypes = {};
}
